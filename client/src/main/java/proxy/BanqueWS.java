 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8096/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8096/?wsdl");
     ...
     * 
     * @return
     *     returns BanqueServvice
     */
    @WebEndpoint(name = "BanqueServvicePort")
    public BanqueServvice getBanqueServvicePort() {
        return super.getPort(new QName("http://ws/", "BanqueServvicePort"), BanqueServvice.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueServvicePort")
    public BanqueServvice getBanqueServvicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BanqueServvicePort"), BanqueServvice.class, features);
    }
